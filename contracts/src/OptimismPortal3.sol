...
contract OptimismPortal3 is Initializable, ResourceMetering, ISemver {
    ...
    /// @notice Address of the Multiproof Oracle.
    /// @custom:network-specific
    IMultiproofOracle public multiproofOracle;
    ...
    mapping(address => bool) private spacer_58_0_32;

    /// @custom:legacy
    /// @custom:spacer respectedGameType
    /// @notice Spacer taking up the legacy `respectedGameType` GameType (uint32) slot.
    uint32 private spacer_59_0_04;

    /// @custom:legacy
    /// @custom:spacer respectedGameTypeUpdatedAt
    /// @notice Spacer taking up the legacy `respectedGameTypeUpdatedAt` uint64 slot.
    uint64 private spacer_59_4_08;
    ...
    function initialize(
        ...
        initializer
    {
        multiproofOracle = _multiproofOracle;
